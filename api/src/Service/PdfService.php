...
class PdfService
{
    ...
    public function setDocInfo(array $_docInfo): static
    {
    ...
    public function setPageConfig(array $_pageConfig): static
    {
     ...
     * @return $this
     */
    public function trimPage(): static
    {
     ...
     * @return $this
     */
    public function setPageSize(array $_pageSize, string $orientation = "P"): static
    {
    ...
    public function setPageTemplateHtml(string $html): static
    {
        $this->pageTemplateHtml = $html;
        return $this;
    }

    public function setTwigTemplate(string $template): static
    {
    ...
    private function setHeaderCss(string $css = ""): static
    {
        $headerCss = <<<EOF
        body { 
