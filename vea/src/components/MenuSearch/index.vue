  ...
  <div @click="openSearchModal">
    ...
    >
      <template #header>
        ...
        >
          <template #prepend>
            <el-button><bt-icon icon-class="bt-search" /></el-button>
          </template>
        </el-input>
      </template>
      ...
      <template #footer>
        <div class="dialog-footer">
          <bt-icon icon-class="bt-EnterKey" size="20px" />
          <span>选择</span>

          <bt-icon icon-class="bt-arrowdown" size="20px" class="ml-5" />
          <bt-icon icon-class="bt-arrowup" size="20px" class="ml-1" />
          <span>切换</span>

          <bt-icon icon-class="bt-EscKey" size="20px" class="ml-5" />
          <span>退出</span>
        </div>
      </template>
    </el-dialog>
