<template>
  <el-scrollbar>
    <div :class="{ hidden: hidden }" class="p-3 pr-20 flex justify-end">
      <el-pagination v-model:current-page="currentPage" v-model:page-size="pageSize" :background="background" :layout="layout"
