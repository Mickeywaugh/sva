<template>
  <div class="app-container">
    ...
    <el-card shadow="never" class="table-wrapper">
      ...
      <pagination
        v-if="noticeTableData.total > 0"
        v-model:total="noticeTableData.total"
...
// 通知公告表格数据
const noticeTableData = ref<PageResult<NoticePageVO>>({
  total: 0,
  list: [],
});
