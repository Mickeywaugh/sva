<template>
  <div class="app-container">
    ...
    <el-card shadow="never">
      <el-table v-loading="loading" :data="logsTableData.list" highlight-current-row border>
      ...
      <pagination
        v-if="logsTableData.total > 0"
        v-model:total="logsTableData.total"
...
// 日志表格数据
const logsTableData = ref<PageResult<LogPageVO>>({
  total: 0,
  list: [],
});
/** 查询 */
