<template>
  <div class="profile-container">
        ...
        <el-card class="user-card">
          <div class="user-info">
            <div class="avatar-wrapper">
              ...
              <el-button type="info" class="avatar-edit-btn" circle :icon="Camera" size="small" @click="triggerFileUpload" />
        ...
        <el-card class="info-card">
          ...
          <el-descriptions :column="1" border>
            ...
            <el-descriptions-item label="手机号码">
              ...
              <el-button v-if="userProfile.mobile" type="primary" link @click="() => handleOpenDialog(DialogType.MOBILE)">
                更换
              </el-button>
            ...
            <el-descriptions-item label="邮箱">
              ...
              <el-button v-if="userProfile.email" type="primary" link @click="() => handleOpenDialog(DialogType.EMAIL)">
                更换
              </el-button>
            ...
            <el-descriptions-item label="OA账号">
              <el-input v-model="userProfile.oaLoginName" @change="(val: string) => bindingOaLoginName(val)" />
            </el-descriptions-item>
    ...
    <el-dialog v-model="dialog.visible" :title="dialog.title" :width="500">
      ...
      <!-- 修改密码 -->
      <el-form v-if="dialog.type === DialogType.PASSWORD" ref="passwordChangeFormRef" :model="passwordChangeForm" :rules="passwordChangeRules"
        :label-width="100">
      ...
      <!-- 绑定手机 -->
      <el-form v-else-if="dialog.type === DialogType.MOBILE" ref="mobileBindingFormRef" :model="mobileUpdateForm" :rules="mobileBindingRules"
        :label-width="100">
      ...
      <!-- 绑定邮箱 -->
      <el-form v-else-if="dialog.type === DialogType.EMAIL" ref="emailBindingFormRef" :model="emailUpdateForm" :rules="emailBindingRules"
        :label-width="100">
        <el-form-item label="邮箱" prop="email">
          <el-input v-model="emailUpdateForm.email" style="width: 250px"><template #append>
...
<script lang="ts" setup>
  ...
  const bindingOaLoginName = async (oaLoginName: string) => {
    await UserAPI.updateProfile({ oaLoginName: oaLoginName }).then(() => {
