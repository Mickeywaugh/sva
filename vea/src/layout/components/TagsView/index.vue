  ...
  <div class="tags-container">
    ...
    >
      <li @click="refreshSelectedTag(selectedTag)">
        <bt-icon icon-class="bt-refresh" />
        {{ $t("common.refresh") }}
      </li>
      <li v-if="!isAffix(selectedTag)" @click="closeSelectedTag(selectedTag)">
        <bt-icon icon-class="bt-o-close" />
        {{ $t("common.close") }}
      </li>
      <li @click="closeOtherTags">
        <bt-icon icon-class="bt-o-check" />
        {{ $t("sys.closeOther") }}
      </li>
      <li v-if="!isFirstView()" @click="closeLeftTags">
        <bt-icon icon-class="bt-step-preview" />
        {{ $t("sys.closeLeft") }}
      </li>
      <li v-if="!isLastView()" @click="closeRightTags">
        <bt-icon icon-class="bt-step-forward" />
        {{ $t("sys.closeRight") }}
      </li>
      <li @click="closeAllTags(selectedTag)">
        <bt-icon icon-class="bt-o-close-fill" />
        {{ $t("sys.closeAll") }}
      </li>
    </ul>
  </div>
